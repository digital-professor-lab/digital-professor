...
\begin{enumerate}
\item Create the \texttt{prototype/frontend} application with the React--TypeScript Vite template, install dependencies, and run the Vite development server. Vite normally serves the application at \url{http://localhost:5173}.\cite{vite}
...
\item Add \texttt{prototype/backend} with a Python virtual environment and FastAPI. Run it locally on a separate port, commonly \url{http://localhost:8000}, and configure the frontend API base URL through a development environment variable.
